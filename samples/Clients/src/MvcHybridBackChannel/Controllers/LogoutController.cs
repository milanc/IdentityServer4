...
namespace MvcHybrid.Controllers
{
    public class LogoutController : Controller
    {
        ...
        private async Task<ClaimsPrincipal> ValidateLogoutToken(string logoutToken)
        {
            ...
            JToken logoutEvent = null;
            if (!events.TryGetValue("http://schemas.openid.net/event/backchannel-logout",out logoutEvent)) throw new Exception("Invalid logout token");
